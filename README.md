...
[![Live Demo](https://img.shields.io/badge/Frontend-Vercel-black?logo=vercel)](https://frontend-py0dda1db-sage1ll1001s-projects.vercel.app)
[![Backend](https://img.shields.io/badge/Backend-Render-46E3B7?logo=render)](https://leadintel-backend.onrender.com/health)
...
| 🗄️ Database (Neon) | PostgreSQL on Neon free tier |

> **Note:** Render free tier sleeps after 15 min of inactivity. First request after sleep takes ~30–60s. Subsequent requests are instant.
...
├── DEPLOYMENT.md        # Live URLs, deployment guide, redeployment instructions
├── INFRASTRUCTURE.md    # Service limits, CORS config, DB schema, API reference
├── CODEBASE.md          # File-by-file codebase reference
├── WORKFLOW.md          # Technical deep-dive — architecture & data flow
└── frontend/            # React + Vite frontend
    ...
    └── src/
        ...
        ├── components/
        │   ├── LeadsTable.jsx   # Sortable table + Status + Notes + Email modal
        ...
        └── pages/
            ...
            ├── LeadsPage.jsx    # Dashboard: filter, sort, paginate, CSV export
...
Response:
```json
{ "google_query": "site:linkedin.com/in \"CEO\" \"Mumbai\"", "leads_scraped": 10, "leads_stored": 8 }
```
...
- **CORS:** Backend allows `localhost:5173`, `127.0.0.1:5173`, explicit `FRONTEND_URL`, and all `*.vercel.app` subdomains
...
- **SPA routing:** `frontend/vercel.json` rewrites all Vercel routes to `index.html`

---

## 📦 Deployment

See [DEPLOYMENT.md](./DEPLOYMENT.md) for full step-by-step instructions for deploying to:
